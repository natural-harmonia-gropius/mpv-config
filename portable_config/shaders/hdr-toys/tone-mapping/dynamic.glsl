...
//!SAVE EMPTY
//!COMPUTE 32 32
//!DESC luminance analysis

void hook() {
    vec4 texelValue = texelFetch(HOOKED_raw, ivec2(gl_GlobalInvocationID.xy), 0);
    ...
    atomicExchange(L_avg, uint(L_sum / gl_WorkGroupSize.x / gl_WorkGroupSize.y / gl_NumWorkGroups.x / gl_NumWorkGroups.y));
}
