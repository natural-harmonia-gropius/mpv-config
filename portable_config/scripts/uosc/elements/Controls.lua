...
function Controls:init_options()
	...
	local shorthands = {
		...
		['audio'] = 'command:library_music:script-binding uosc/audio#audio>1?' .. t('Audio'),
		['audio-device'] = 'command:media_output:script-binding uosc/audio-device?' .. t('Audio device'),
		...
		['prev'] = 'command:chevron_left:script-binding uosc/prev?' .. t('Previous'),
		['next'] = 'command:chevron_right:script-binding uosc/next?' .. t('Next'),
