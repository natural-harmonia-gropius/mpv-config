...
[yt-dlp](https://github.com/yt-dlp/yt-dlp/releases), put it in mpv folder. (optional)

- or [yt-dlp-nightly-builds](https://github.com/yt-dlp/yt-dlp-nightly-builds/releases)
- `ytdl.ps1` is provided with optimized options.

[vapoursynth](https://github.com/vapoursynth/vapoursynth/releases) and [python](https://www.python.org/downloads), extract them to mpv folder. (optional)
...
- [SVPflow](https://www.svp-team.com/get/) v4.3.0.165+ require SVP Manager running.
- dlls need to be placed in `vapoursynth64/plugins`.
- `interp.py` is provided with optimized parameters. `=` to enable motion interpolation, `-` to disable.
